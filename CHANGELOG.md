...
- **Downloaded installer flow** — download the installer to a temporary file, inspect if desired, then run it with `bash`; it provisions workspace + gateway + defaults
