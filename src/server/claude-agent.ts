    ...
    try {
      ...
      if (claudeBin) {
        ...
        return {
          ok: false,
          error:
            'hermes-agent not found. Run the installer: curl -fsSL https://hermes-workspace.com/install.sh -o /tmp/hermes-workspace-install.sh; bash /tmp/hermes-workspace-install.sh',
        }
      }
